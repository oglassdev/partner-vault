...
export const ProfileSchema = v.object({
  display_name: v.string("Your display name must be a string.", [
    v.minLength(2, "Your display name must contain at least 2 characters."),
    v.maxLength(64, "Your display name must be less than 64 characters."),
  ]),
